      ...
      {links.map(({ to, label }) => (
        <Link
          ...
          style={{
            ...
            fontSize: '10px',
            letterSpacing: '0.3em',
            color: hovered === to ? '#FFD700' : 'rgba(245,240,232,0.55)',
            textDecoration: 'none',
            textTransform: 'uppercase',
            padding: '0.6rem 1.4rem',
            background: hovered === to ? 'rgba(255,215,0,0.06)' : 'transparent',
            borderLeft: hovered === to ? '1px solid #FFD700' : '1px solid transparent',
