...
export default function SomaFeatureBlock({ feature }) {
  ...
  return (
    ...
    >
      ...
      >
        <circle cx="50" cy="50" r="45" stroke="#D4AF37" strokeWidth="0.5" fill="none" />
        <circle cx="50" cy="50" r="30" stroke="#D4AF37" strokeWidth="0.5" fill="none" />
        <circle cx="50" cy="50" r="15" stroke="#D4AF37" strokeWidth="0.5" fill="none" />
        <line x1="5" y1="50" x2="95" y2="50" stroke="#D4AF37" strokeWidth="0.3" />
        <line x1="50" y1="5" x2="50" y2="95" stroke="#D4AF37" strokeWidth="0.3" />
      </svg>
